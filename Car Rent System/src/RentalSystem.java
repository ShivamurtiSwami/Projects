...
class RentalSystem {
        ...
        public void menu(){
            ...
            while (true) {
                System.out.println("=======Welcome to ABC Car Rent=========");
                System.out.println("1. Rent a Car...");
                System.out.println("2. Return a Cars.");
                ...
                if(choice==1){
                    ...
                    for(Car car:cars){
                        if(car.isIsavailable()){
                            System.out.println(car.getCarId()+" "+car.getCbrand()+" "+car.getCmodel());
                        }
                    }
                    ...
                    if (selectedCar != null) {
                        ...
                        System.out.println("Car: " + selectedCar.getCbrand() + " " + selectedCar.getCmodel());
